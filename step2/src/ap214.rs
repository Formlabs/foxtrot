...
impl<'a> PreferredSurfaceCurveRepresentation<'a> {
    pub fn parse(s: &'a str) -> IResult<'a, Self> {
...
impl<'a> ProductOrPresentationSpace<'a> {
    pub fn parse(s: &'a str) -> IResult<'a, Self> {
