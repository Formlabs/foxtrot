...
fn data_line(input: &str) -> Res<&str, (Id, DataEntity)> {
    ...
    match opt_iden.unwrap() {
                "ADVANCED_BREP_SHAPE_REPRESENTATION" => data_entity_advanced_brep_shape_representation(next_input),
        "ADVANCED_FACE" => data_entity_advanced_face(next_input),
        "APPLICATION_CONTEXT" => data_entity_application_context(next_input),
        "APPLICATION_PROTOCOL_DEFINITION" => data_entity_application_protocol_definition(next_input),
        ...
        "CONTEXT_DEPENDENT_SHAPE_REPRESENTATION" => data_entity_context_dependent_shape_representation(next_input),
        ...
        "DESCRIPTIVE_REPRESENTATION_ITEM" => data_entity_descriptive_representation_item(next_input),
        ...
        "DRAUGHTING_PRE_DEFINED_CURVE_FONT" => data_entity_draughting_pre_defined_curve_font(next_input),
        ...
        "MANIFOLD_SURFACE_SHAPE_REPRESENTATION" => data_entity_manifold_surface_shape_representation(next_input),
        "MEASURE_REPRESENTATION_ITEM" => data_entity_measure_representation_item(next_input),
        "MECHANICAL_DESIGN_GEOMETRIC_PRESENTATION_REPRESENTATION" => data_entity_mechanical_design_geometric_presentation_representation(next_input),
        ...
        "PRODUCT_DEFINITION_FORMATION_WITH_SPECIFIED_SOURCE" => data_entity_product_definition_formation_with_specified_source(next_input),
        "PRODUCT_DEFINITION_SHAPE" => data_entity_product_definition_shape(next_input),
        "PRODUCT_RELATED_PRODUCT_CATEGORY" => data_entity_product_related_product_category(next_input),
        "PROPERTY_DEFINITION" => data_entity_property_definition(next_input),
        "PROPERTY_DEFINITION_REPRESENTATION" => data_entity_property_definition_representation(next_input),
        "REPRESENTATION" => data_entity_representation(next_input),
        "SHAPE_ASPECT" => data_entity_shape_aspect(next_input),
        "SHAPE_DEFINITION_REPRESENTATION" => data_entity_shape_definition_representation(next_input),
        "SHAPE_REPRESENTATION" => data_entity_shape_representation(next_input),
        "SHAPE_REPRESENTATION_RELATIONSHIP" => data_entity_shape_representation_relationship(next_input),
...
mod tests {
    ...
    fn test_advanced_brep_shape_representation() {
        assert!(data_entity_advanced_brep_shape_representation("('',(#11,#162601),#162751);").is_ok());
        assert!(data_entity_advanced_brep_shape_representation("('',(#11,#172997),#173477);").is_ok());
        assert!(data_entity_advanced_brep_shape_representation("('',(#11,#177013),#177555);").is_ok());
        assert!(data_entity_advanced_brep_shape_representation("('',(#11,#164807),#164957);").is_ok());
        assert!(data_entity_advanced_brep_shape_representation("('',(#11,#369341),#371680);").is_ok());
        assert!(data_entity_advanced_brep_shape_representation("('',(#11,#163891),#164041);").is_ok());
        assert!(data_entity_advanced_brep_shape_representation("('',(#11,#8249),#8791);").is_ok());
        assert!(data_entity_advanced_brep_shape_representation("('',(#11,#162171),#162321);").is_ok());
        assert!(data_entity_advanced_brep_shape_representation("('',(#11,#381801),#382783);").is_ok());
        assert!(data_entity_advanced_brep_shape_representation("('',(#11,#35262),#39038);").is_ok());
        assert!(data_entity_advanced_brep_shape_representation("('',(#11,#159437),#159719);").is_ok());
        assert!(data_entity_advanced_brep_shape_representation("('',(#11,#174414),#176988);").is_ok());
        assert!(data_entity_advanced_brep_shape_representation("('',(#11,#180249),#180791);").is_ok());
        assert!(data_entity_advanced_brep_shape_representation("('',(#11,#322309),#322599);").is_ok());
        assert!(data_entity_advanced_brep_shape_representation("('',(#11,#155097),#155907);").is_ok());
        assert!(data_entity_advanced_brep_shape_representation("('',(#11,#129055),#129205);").is_ok());
        assert!(data_entity_advanced_brep_shape_representation("('',(#11,#130148),#130298);").is_ok());
        assert!(data_entity_advanced_brep_shape_representation("('',(#11,#364898),#369278);").is_ok());
        assert!(data_entity_advanced_brep_shape_representation("('',(#11,#159788),#160697);").is_ok());
        assert!(data_entity_advanced_brep_shape_representation("('',(#11,#163031),#163181);").is_ok());
        assert!(data_entity_advanced_brep_shape_representation("('',(#11,#202851),#203001);").is_ok());
        assert!(data_entity_advanced_brep_shape_representation("('',(#11,#383868),#384850);").is_ok());
        assert!(data_entity_advanced_brep_shape_representation("('',(#11,#154878),#155028);").is_ok());
        assert!(data_entity_advanced_brep_shape_representation("('',(#11,#40572),#41735);").is_ok());
        assert!(data_entity_advanced_brep_shape_representation("('',(#11,#158630),#158780);").is_ok());
    }
    ...
    fn test_advanced_face() {
        ...
        assert!(data_entity_advanced_face("('',(#119434),#119445,.T.);").is_ok());
        assert!(data_entity_advanced_face("('',(#273910),#273921,.T.);").is_ok());
        assert!(data_entity_advanced_face("('',(#57231),#57250,.T.);").is_ok());
        assert!(data_entity_advanced_face("('',(#174887),#174898,.T.);").is_ok());
        assert!(data_entity_advanced_face("('',(#247282),#247300,.T.);").is_ok());
        assert!(data_entity_advanced_face("('',(#330771),#330782,.T.);").is_ok());
        assert!(data_entity_advanced_face("('',(#67008),#67033,.T.);").is_ok());
        assert!(data_entity_advanced_face("('',(#8597),#8616,.T.);").is_ok());
        assert!(data_entity_advanced_face("('',(#273115),#273126,.T.);").is_ok());
        assert!(data_entity_advanced_face("('',(#11551),#11557,.F.);").is_ok());
        assert!(data_entity_advanced_face("('',(#309631),#309659,.F.);").is_ok());
        assert!(data_entity_advanced_face("('',(#394413),#394427,.T.);").is_ok());
        assert!(data_entity_advanced_face("('',(#25740),#25752,.T.);").is_ok());
        assert!(data_entity_advanced_face("('',(#363789),#363819,.F.);").is_ok());
        assert!(data_entity_advanced_face("('',(#256034),#256040,.T.);").is_ok());
    }
    ...
    fn test_application_protocol_definition() {
        assert!(data_entity_application_protocol_definition("('international standard',\n  'automotive_design',2000,#2);").is_ok());
    }
    ...
    fn test_axis2_placement_3d() {
        ...
        assert!(data_entity_axis2_placement_3d("('',#390141,#390142,#390143);").is_ok());
        assert!(data_entity_axis2_placement_3d("('',#41565,#41566,#41567);").is_ok());
        assert!(data_entity_axis2_placement_3d("('',#267816,#267817,#267818);").is_ok());
        assert!(data_entity_axis2_placement_3d("('',#393936,#393937,#393938);").is_ok());
        assert!(data_entity_axis2_placement_3d("('',#47006,#47007,#47008);").is_ok());
        assert!(data_entity_axis2_placement_3d("('',#113337,#113338,#113339);").is_ok());
        assert!(data_entity_axis2_placement_3d("('',#278483,#278484,#278485);").is_ok());
        assert!(data_entity_axis2_placement_3d("('',#313240,#313241,#313242);").is_ok());
        assert!(data_entity_axis2_placement_3d("('',#265820,#265821,#265822);").is_ok());
        assert!(data_entity_axis2_placement_3d("('',#74656,#74657,#74658);").is_ok());
        assert!(data_entity_axis2_placement_3d("('',#146604,#146605,#146606);").is_ok());
        assert!(data_entity_axis2_placement_3d("('',#62913,#62914,#62915);").is_ok());
        assert!(data_entity_axis2_placement_3d("('',#262995,#262996,#262997);").is_ok());
        assert!(data_entity_axis2_placement_3d("('',#211671,#211672,#211673);").is_ok());
        assert!(data_entity_axis2_placement_3d("('',#72653,#72654,#72655);").is_ok());
    }
    ...
    fn test_b_spline_curve_with_knots() {
        ...
        assert!(data_entity_b_spline_curve_with_knots("('',3,(#273375,#273376,#273377,\n    #273378),.UNSPECIFIED.,.F.,.F.,(4,4),(0.E+000,1.),\n  .PIECEWISE_BEZIER_KNOTS.);").is_ok());
        assert!(data_entity_b_spline_curve_with_knots("('',3,(#269970,#269971,#269972,\n    #269973),.UNSPECIFIED.,.F.,.F.,(4,4),(0.E+000,1.),\n  .PIECEWISE_BEZIER_KNOTS.);").is_ok());
        assert!(data_entity_b_spline_curve_with_knots("('',3,(#286562,#286563,#286564,\n    #286565,#286566),.UNSPECIFIED.,.F.,.F.,(4,1,4),(0.E+000,0.5,1.),\n  .QUASI_UNIFORM_KNOTS.);").is_ok());
        assert!(data_entity_b_spline_curve_with_knots("('',4,(#6984,#6985,#6986,#6987,#6988),\n  .UNSPECIFIED.,.F.,.F.,(5,5),(0.E+000,1.570796326795),\n  .PIECEWISE_BEZIER_KNOTS.);").is_ok());
        assert!(data_entity_b_spline_curve_with_knots("('',4,(#45051,#45052,#45053,#45054,\n    #45055),.UNSPECIFIED.,.F.,.F.,(5,5),(0.E+000,1.559869909752),\n  .PIECEWISE_BEZIER_KNOTS.);").is_ok());
        assert!(data_entity_b_spline_curve_with_knots("('',4,(#176074,#176075,#176076,\n    #176077,#176078),.UNSPECIFIED.,.F.,.F.,(5,5),(0.E+000,1.570796326795\n    ),.PIECEWISE_BEZIER_KNOTS.);").is_ok());
        assert!(data_entity_b_spline_curve_with_knots("('',3,(#262819,#262820,#262821,\n    #262822),.UNSPECIFIED.,.F.,.F.,(4,4),(0.E+000,1.),\n  .PIECEWISE_BEZIER_KNOTS.);").is_ok());
        assert!(data_entity_b_spline_curve_with_knots("('',3,(#393860,#393861,#393862,\n    #393863),.UNSPECIFIED.,.F.,.F.,(4,4),(0.E+000,1.099543901406E-005),\n  .PIECEWISE_BEZIER_KNOTS.);").is_ok());
        assert!(data_entity_b_spline_curve_with_knots("('',3,(#134762,#134763,#134764,\n    #134765),.UNSPECIFIED.,.F.,.F.,(4,4),(0.E+000,0.10471975512),\n  .PIECEWISE_BEZIER_KNOTS.);").is_ok());
        assert!(data_entity_b_spline_curve_with_knots("('',3,(#286485,#286486,#286487,\n    #286488,#286489),.UNSPECIFIED.,.F.,.F.,(4,1,4),(0.E+000,0.5,1.),\n  .QUASI_UNIFORM_KNOTS.);").is_ok());
        assert!(data_entity_b_spline_curve_with_knots("('',3,(#183031,#183032,#183033,\n    #183034),.UNSPECIFIED.,.F.,.F.,(4,4),(0.E+000,0.10471975512),\n  .PIECEWISE_BEZIER_KNOTS.);").is_ok());
        assert!(data_entity_b_spline_curve_with_knots("('',3,(#393793,#393794,#393795,\n    #393796),.UNSPECIFIED.,.F.,.F.,(4,4),(0.E+000,5.998181191398E-006),\n  .PIECEWISE_BEZIER_KNOTS.);").is_ok());
        assert!(data_entity_b_spline_curve_with_knots("('',4,(#44559,#44560,#44561,#44562,\n    #44563),.UNSPECIFIED.,.F.,.F.,(5,5),(0.E+000,1.570796326795),\n  .PIECEWISE_BEZIER_KNOTS.);").is_ok());
        assert!(data_entity_b_spline_curve_with_knots("('',3,(#61675,#61676,#61677,#61678,\n    #61679,#61680,#61681,#61682,#61683,#61684),.UNSPECIFIED.,.F.,.F.,(4,\n    2,2,2,4),(2.424349759031E-019,1.241242893482E-003,\n    2.482485786963E-003,3.723728680445E-003,4.964971573926E-003),\n  .UNSPECIFIED.);").is_ok());
        assert!(data_entity_b_spline_curve_with_knots("('',3,(#185588,#185589,#185590,\n    #185591),.UNSPECIFIED.,.F.,.F.,(4,4),(0.E+000,0.10471975512),\n  .PIECEWISE_BEZIER_KNOTS.);").is_ok());
    }
    ...
    fn test_cartesian_point() {
        ...
        assert!(data_entity_cartesian_point("('',(5.9199999994,11.67498095209,-2.6699999998)\n  );").is_ok());
        ...
        assert!(data_entity_cartesian_point("('',(0.14294104,-5.315711999999E-002,0.E+000));").is_ok());
        assert!(data_entity_cartesian_point("('',(32.,-2.05,9.9));").is_ok());
        assert!(data_entity_cartesian_point("('',(6.201663060342,1.801193405256E-012,\n    -13.9061182435));").is_ok());
        assert!(data_entity_cartesian_point("('',(-0.2499995,-2.89999928,0.E+000));").is_ok());
        assert!(data_entity_cartesian_point("('',(16.91592428742,8.951657804289,\n    -21.11046879016));").is_ok());
        assert!(data_entity_cartesian_point("('',(1.175,1.49,-0.84));").is_ok());
        assert!(data_entity_cartesian_point("('',(-2.625,1.2,-3.05));").is_ok());
        assert!(data_entity_cartesian_point("('',(0.E+000,3.2,0.775));").is_ok());
        assert!(data_entity_cartesian_point("('',(-4.15000000001,7.30000000001,0.15000000001)\n  );").is_ok());
        assert!(data_entity_cartesian_point("('',(-30.075,0.85,-6.95));").is_ok());
        assert!(data_entity_cartesian_point("('',(3.199666448243,5.531029750749E-002,\n    0.772574954701));").is_ok());
        assert!(data_entity_cartesian_point("('',(6.325,0.11,-5.2));").is_ok());
        assert!(data_entity_cartesian_point("('',(-6.499999999996E-002,0.720743124491,\n    -11.49099999985));").is_ok());
        assert!(data_entity_cartesian_point("('',(-4.675,0.95,-0.820036725769));").is_ok());
        assert!(data_entity_cartesian_point("('',(7.109001805981E-004,5.573656791976E-002,\n    0.770584088296));").is_ok());
        assert!(data_entity_cartesian_point("('',(2.203101555092E-002,3.191814220383,\n    0.980117378007));").is_ok());
        assert!(data_entity_cartesian_point("('',(0.E+000,0.E+000,0.E+000));").is_ok());
        assert!(data_entity_cartesian_point("('',(6.550273515208,9.634980952092,\n    -3.349092668505));").is_ok());
        assert!(data_entity_cartesian_point("('',(4.257302746373,11.50039416076,\n    -19.76500600004));").is_ok());
    }
    ...
    fn test_circle() {
        ...
        assert!(data_entity_circle("('',#84216,0.36);").is_ok());
        assert!(data_entity_circle("('',#317775,4.2);").is_ok());
        assert!(data_entity_circle("('',#316019,1.3);").is_ok());
        assert!(data_entity_circle("('',#25997,1.62E-002);").is_ok());
        assert!(data_entity_circle("('',#372202,5.E-002);").is_ok());
        assert!(data_entity_circle("('',#244810,1.8);").is_ok());
        assert!(data_entity_circle("('',#42422,0.25);").is_ok());
        assert!(data_entity_circle("('',#334479,1.5);").is_ok());
        assert!(data_entity_circle("('',#3283,0.3999992);").is_ok());
        assert!(data_entity_circle("('',#290737,0.5);").is_ok());
        assert!(data_entity_circle("('',#61077,0.25);").is_ok());
        assert!(data_entity_circle("('',#320385,4.2);").is_ok());
        assert!(data_entity_circle("('',#379892,5.E-002);").is_ok());
        assert!(data_entity_circle("('',#141338,0.3);").is_ok());
        assert!(data_entity_circle("('',#168666,0.8);").is_ok());
    }
    ...
    fn test_closed_shell() {
        ...
        assert!(data_entity_closed_shell("('',(#374392,#374432,#374463,#374494,#374516,\n    #374528));").is_ok());
    ...
    fn test_colour_rgb() {
        ...
        assert!(data_entity_colour_rgb("('',0.188235297799,0.188235297799,0.188235297799);").is_ok());
        assert!(data_entity_colour_rgb("('',0.E+000,0.501960813999,0.E+000);").is_ok());
        assert!(data_entity_colour_rgb("('',0.752941191196,0.752941191196,0.752941191196);").is_ok());
        assert!(data_entity_colour_rgb("('',0.313725501299,0.313725501299,0.313725501299);").is_ok());
        assert!(data_entity_colour_rgb("('',0.941176474094,1.,1.);").is_ok());
        assert!(data_entity_colour_rgb("('',0.501960813999,0.501960813999,0.501960813999);").is_ok());
        assert!(data_entity_colour_rgb("('',0.580392181873,0.580392181873,0.627451002598);").is_ok());
        assert!(data_entity_colour_rgb("('',0.564705908298,0.564705908298,0.564705908298);").is_ok());
        assert!(data_entity_colour_rgb("('',0.298039227724,0.298039227724,0.298039227724);").is_ok());
        assert!(data_entity_colour_rgb("('',0.109803922474,0.109803922474,0.109803922474);").is_ok());
        assert!(data_entity_colour_rgb("('',0.690196096897,0.690196096897,0.690196096897);").is_ok());
        assert!(data_entity_colour_rgb("('',0.250980407,0.250980407,0.250980407);").is_ok());
        assert!(data_entity_colour_rgb("('',0.E+000,0.580392181873,0.611764729023);").is_ok());
        assert!(data_entity_colour_rgb("('',0.647058844566,0.517647087574,0.E+000);").is_ok());
        assert!(data_entity_colour_rgb("('',0.160784319043,0.160784319043,0.160784319043);").is_ok());
        assert!(data_entity_colour_rgb("('',0.152941182256,0.305882364511,\n  7.450980693102E-002);").is_ok());
    }
    ...
    fn test_conical_surface() {
        ...
        assert!(data_entity_conical_surface("('',#72146,1.825,0.352833819799);").is_ok());
        assert!(data_entity_conical_surface("('',#72792,1.825,0.463647609002);").is_ok());
        assert!(data_entity_conical_surface("('',#336045,4.9,0.785398163397);").is_ok());
        assert!(data_entity_conical_surface("('',#241111,0.234530705359,0.523574705607);").is_ok());
    }
    ...
    fn test_context_dependent_shape_representation() {
        ...
        assert!(data_entity_context_dependent_shape_representation("(#138226,#138228);").is_ok());
        assert!(data_entity_context_dependent_shape_representation("(#323409,#323411);").is_ok());
        assert!(data_entity_context_dependent_shape_representation("(#395108,#395110);").is_ok());
        assert!(data_entity_context_dependent_shape_representation("(#129998,#130000);").is_ok());
        assert!(data_entity_context_dependent_shape_representation("(#43007,#43009);").is_ok());
        assert!(data_entity_context_dependent_shape_representation("(#202699,#202701);").is_ok());
        assert!(data_entity_context_dependent_shape_representation("(#42928,#42930);").is_ok());
        assert!(data_entity_context_dependent_shape_representation("(#8963,#8965);").is_ok());
        assert!(data_entity_context_dependent_shape_representation("(#376197,#376199);").is_ok());
        assert!(data_entity_context_dependent_shape_representation("(#202283,#202285);").is_ok());
        assert!(data_entity_context_dependent_shape_representation("(#202171,#202173);").is_ok());
        assert!(data_entity_context_dependent_shape_representation("(#201191,#201193);").is_ok());
        assert!(data_entity_context_dependent_shape_representation("(#153285,#153287);").is_ok());
        assert!(data_entity_context_dependent_shape_representation("(#323694,#323696);").is_ok());
        assert!(data_entity_context_dependent_shape_representation("(#165873,#165875);").is_ok());
    }

    #[test]
    fn test_curve_style() {
        assert!(data_entity_curve_style("('',#412981,POSITIVE_LENGTH_MEASURE(0.1),#406004);").is_ok());
        assert!(data_entity_curve_style("('',#402574,POSITIVE_LENGTH_MEASURE(0.1),#401618);").is_ok());
        assert!(data_entity_curve_style("('',#402223,POSITIVE_LENGTH_MEASURE(0.1),#401618);").is_ok());
        assert!(data_entity_curve_style("('',#412935,POSITIVE_LENGTH_MEASURE(0.1),#403072);").is_ok());
        assert!(data_entity_curve_style("('',#406720,POSITIVE_LENGTH_MEASURE(0.1),#406718);").is_ok());
        assert!(data_entity_curve_style("('',#402709,POSITIVE_LENGTH_MEASURE(0.1),#401618);").is_ok());
        assert!(data_entity_curve_style("('',#413044,POSITIVE_LENGTH_MEASURE(0.1),#406004);").is_ok());
        assert!(data_entity_curve_style("('',#401863,POSITIVE_LENGTH_MEASURE(0.1),#401618);").is_ok());
        assert!(data_entity_curve_style("('',#413440,POSITIVE_LENGTH_MEASURE(0.1),#406004);").is_ok());
        assert!(data_entity_curve_style("('',#416525,POSITIVE_LENGTH_MEASURE(0.1),#416523);").is_ok());
        assert!(data_entity_curve_style("('',#416494,POSITIVE_LENGTH_MEASURE(0.1),#400136);").is_ok());
        assert!(data_entity_curve_style("('',#401701,POSITIVE_LENGTH_MEASURE(0.1),#401618);").is_ok());
        assert!(data_entity_curve_style("('',#403063,POSITIVE_LENGTH_MEASURE(0.1),#399650);").is_ok());
        assert!(data_entity_curve_style("('',#406231,POSITIVE_LENGTH_MEASURE(0.1),#406004);").is_ok());
        assert!(data_entity_curve_style("('',#413179,POSITIVE_LENGTH_MEASURE(0.1),#406004);").is_ok());
        assert!(data_entity_curve_style("('',#402475,POSITIVE_LENGTH_MEASURE(0.1),#401618);").is_ok());
        assert!(data_entity_curve_style("('',#402961,POSITIVE_LENGTH_MEASURE(0.1),#401618);").is_ok());
        assert!(data_entity_curve_style("('',#401800,POSITIVE_LENGTH_MEASURE(0.1),#401618);").is_ok());
        assert!(data_entity_curve_style("('',#402781,POSITIVE_LENGTH_MEASURE(0.1),#401618);").is_ok());
        assert!(data_entity_curve_style("('',#406204,POSITIVE_LENGTH_MEASURE(0.1),#406004);").is_ok());
        assert!(data_entity_curve_style("('',#412136,POSITIVE_LENGTH_MEASURE(0.1),#403051);").is_ok());
        assert!(data_entity_curve_style("('',#402151,POSITIVE_LENGTH_MEASURE(0.1),#401618);").is_ok());
        assert!(data_entity_curve_style("('',#403015,POSITIVE_LENGTH_MEASURE(0.1),#401618);").is_ok());
        assert!(data_entity_curve_style("('',#416484,POSITIVE_LENGTH_MEASURE(0.1),#403072);").is_ok());
        assert!(data_entity_curve_style("('',#402358,POSITIVE_LENGTH_MEASURE(0.1),#401618);").is_ok());
    }
    ...
    fn test_cylindrical_surface() {
        ...
        assert!(data_entity_cylindrical_surface("('',#389940,0.126);").is_ok());
        assert!(data_entity_cylindrical_surface("('',#4480,0.4499991);").is_ok());
        assert!(data_entity_cylindrical_surface("('',#394106,0.125);").is_ok());
        assert!(data_entity_cylindrical_surface("('',#133945,0.1);").is_ok());
        assert!(data_entity_cylindrical_surface("('',#169245,0.25);").is_ok());
        assert!(data_entity_cylindrical_surface("('',#332123,5.E-002);").is_ok());
        assert!(data_entity_cylindrical_surface("('',#298239,4.2);").is_ok());
        assert!(data_entity_cylindrical_surface("('',#4282,1.15000024);").is_ok());
        assert!(data_entity_cylindrical_surface("('',#190737,5.E-002);").is_ok());
        assert!(data_entity_cylindrical_surface("('',#4051,0.7999984);").is_ok());
        assert!(data_entity_cylindrical_surface("('',#188570,5.E-002);").is_ok());
        assert!(data_entity_cylindrical_surface("('',#145130,0.3);").is_ok());
        assert!(data_entity_cylindrical_surface("('',#300849,4.2);").is_ok());
        assert!(data_entity_cylindrical_surface("('',#41606,3.E-002);").is_ok());
        assert!(data_entity_cylindrical_surface("('',#260947,8.E-002);").is_ok());
    }
    ...
    fn test_direction() {
        ...
        assert!(data_entity_direction("('',(0.E+000,0.E+000,1.));").is_ok());
        assert!(data_entity_direction("('',(0.E+000,0.E+000,1.));").is_ok());
        assert!(data_entity_direction("('',(0.E+000,-5.892403111334E-016,1.));").is_ok());
        assert!(data_entity_direction("('',(0.E+000,1.,-0.E+000));").is_ok());
        assert!(data_entity_direction("('',(-0.407575994194,-0.913171292232,0.E+000));").is_ok());
        assert!(data_entity_direction("('',(0.E+000,0.E+000,-1.));").is_ok());
        assert!(data_entity_direction("('',(-0.E+000,-1.,0.E+000));").is_ok());
    }
    ...
    fn test_edge_curve() {
        ...
        assert!(data_entity_edge_curve("('',#144644,#144652,#144654,.T.);").is_ok());
        assert!(data_entity_edge_curve("('',#56511,#56503,#56513,.T.);").is_ok());
        assert!(data_entity_edge_curve("('',#259884,#206446,#259886,.T.);").is_ok());
        assert!(data_entity_edge_curve("('',#22515,#21549,#22523,.T.);").is_ok());
        assert!(data_entity_edge_curve("('',#58793,#58785,#58795,.T.);").is_ok());
        assert!(data_entity_edge_curve("('',#60828,#60837,#60839,.T.);").is_ok());
        assert!(data_entity_edge_curve("('',#101010,#101002,#101012,.T.);").is_ok());
        assert!(data_entity_edge_curve("('',#86427,#86353,#86429,.T.);").is_ok());
        assert!(data_entity_edge_curve("('',#396849,#396880,#396882,.T.);").is_ok());
        assert!(data_entity_edge_curve("('',#376613,#376819,#376821,.T.);").is_ok());
        assert!(data_entity_edge_curve("('',#6656,#6648,#6658,.T.);").is_ok());
        assert!(data_entity_edge_curve("('',#365227,#366098,#366100,.T.);").is_ok());
        assert!(data_entity_edge_curve("('',#113032,#113021,#113040,.T.);").is_ok());
        assert!(data_entity_edge_curve("('',#368970,#368978,#368980,.T.);").is_ok());
        assert!(data_entity_edge_curve("('',#32121,#32113,#32123,.T.);").is_ok());
    }
    ...
    fn test_edge_loop() {
        ...
        assert!(data_entity_edge_loop("('',(#240673,#240674,#240680,#240681,#240682,#240688,\n    #240689,#240697));").is_ok());
        assert!(data_entity_edge_loop("('',(#88124,#88125,#88126,#88127,#88128,#88129,#88137,\n    #88145));").is_ok());
        ...
        assert!(data_entity_edge_loop("('',(#265225,#265226,#265235,#265244,#265252,#265259)\n  );").is_ok());
        assert!(data_entity_edge_loop("('',(#355494,#355502,#355511,#355519,#355520));").is_ok());
        assert!(data_entity_edge_loop("('',(#66381,#66390,#66398,#66405));").is_ok());
        assert!(data_entity_edge_loop("('',(#112534,#112542,#112543,#112544,#112545,#112553)\n  );").is_ok());
        assert!(data_entity_edge_loop("('',(#11787,#11796,#11797,#11806));").is_ok());
        assert!(data_entity_edge_loop("('',(#5954,#5955,#5964,#5972));").is_ok());
        assert!(data_entity_edge_loop("('',(#122644,#122645,#122651,#122652));").is_ok());
        assert!(data_entity_edge_loop("('',(#307219,#307220,#307226,#307227));").is_ok());
        assert!(data_entity_edge_loop("('',(#389069,#389070,#389071,#389072));").is_ok());
        assert!(data_entity_edge_loop("('',(#26134,#26135,#26143,#26151));").is_ok());
        assert!(data_entity_edge_loop("('',(#382746,#382747,#382754,#382755));").is_ok());
        assert!(data_entity_edge_loop("('',(#301175,#301176,#301177,#301185,#301193,#301201,\n    #301209));").is_ok());
        assert!(data_entity_edge_loop("('',(#241877,#241878,#241879,#241880));").is_ok());
        assert!(data_entity_edge_loop("('',(#368519,#368520,#368521,#368522,#368523,#368524)\n  );").is_ok());
        assert!(data_entity_edge_loop("('',(#32622,#32630,#32636,#32637));").is_ok());
    }
    ...
    fn test_ellipse() {
        ...
        assert!(data_entity_ellipse("('',#181780,5.027541397818E-002,5.E-002);").is_ok());
        assert!(data_entity_ellipse("('',#177725,5.027541397818E-002,5.E-002);").is_ok());
        assert!(data_entity_ellipse("('',#184236,5.027541397818E-002,5.E-002);").is_ok());
        assert!(data_entity_ellipse("('',#184253,5.027541397818E-002,5.E-002);").is_ok());
        assert!(data_entity_ellipse("('',#178516,5.027541397818E-002,5.E-002);").is_ok());
        assert!(data_entity_ellipse("('',#175154,5.027541397818E-002,5.E-002);").is_ok());
        assert!(data_entity_ellipse("('',#174472,5.027541397818E-002,5.E-002);").is_ok());
        assert!(data_entity_ellipse("('',#180972,5.027541397818E-002,5.E-002);").is_ok());
        assert!(data_entity_ellipse("('',#181055,5.027541397818E-002,5.E-002);").is_ok());
        assert!(data_entity_ellipse("('',#181765,5.027541397818E-002,5.E-002);").is_ok());
        assert!(data_entity_ellipse("('',#175280,5.027541397818E-002,5.E-002);").is_ok());
        assert!(data_entity_ellipse("('',#184918,5.027541397818E-002,5.E-002);").is_ok());
        assert!(data_entity_ellipse("('',#180989,5.027541397818E-002,5.E-002);").is_ok());
        assert!(data_entity_ellipse("('',#177774,5.027541397818E-002,5.E-002);").is_ok());
        assert!(data_entity_ellipse("('',#133235,0.150260191002,0.10625);").is_ok());
    }
    ...
    fn test_face_bound() {
        ...
        assert!(data_entity_face_bound("('',#265224,.F.);").is_ok());
        assert!(data_entity_face_bound("('',#355493,.T.);").is_ok());
        assert!(data_entity_face_bound("('',#66380,.T.);").is_ok());
        assert!(data_entity_face_bound("('',#112533,.T.);").is_ok());
        assert!(data_entity_face_bound("('',#11786,.T.);").is_ok());
        assert!(data_entity_face_bound("('',#5953,.T.);").is_ok());
        assert!(data_entity_face_bound("('',#122643,.T.);").is_ok());
        assert!(data_entity_face_bound("('',#307218,.T.);").is_ok());
        assert!(data_entity_face_bound("('',#389068,.F.);").is_ok());
        assert!(data_entity_face_bound("('',#26133,.T.);").is_ok());
        assert!(data_entity_face_bound("('',#382745,.F.);").is_ok());
        assert!(data_entity_face_bound("('',#301174,.F.);").is_ok());
        assert!(data_entity_face_bound("('',#241876,.F.);").is_ok());
        assert!(data_entity_face_bound("('',#368518,.T.);").is_ok());
        assert!(data_entity_face_bound("('',#32621,.T.);").is_ok());
    }
    ...
    fn test_fill_area_style() {
        ...
        assert!(data_entity_fill_area_style("('',(#422175));").is_ok());
        assert!(data_entity_fill_area_style("('',(#422966));").is_ok());
        assert!(data_entity_fill_area_style("('',(#408452));").is_ok());
        assert!(data_entity_fill_area_style("('',(#424534));").is_ok());
        assert!(data_entity_fill_area_style("('',(#401532));").is_ok());
        assert!(data_entity_fill_area_style("('',(#407969));").is_ok());
        assert!(data_entity_fill_area_style("('',(#419554));").is_ok());
        assert!(data_entity_fill_area_style("('',(#424310));").is_ok());
        assert!(data_entity_fill_area_style("('',(#404493));").is_ok());
        assert!(data_entity_fill_area_style("('',(#414294));").is_ok());
        assert!(data_entity_fill_area_style("('',(#410431));").is_ok());
        assert!(data_entity_fill_area_style("('',(#407324));").is_ok());
        assert!(data_entity_fill_area_style("('',(#403560));").is_ok());
        assert!(data_entity_fill_area_style("('',(#401690));").is_ok());
        assert!(data_entity_fill_area_style("('',(#412345));").is_ok());
    }
    ...
    fn test_fill_area_style_colour() {
        ...
        assert!(data_entity_fill_area_style_colour("('',#399650);").is_ok());
        assert!(data_entity_fill_area_style_colour("('',#416551);").is_ok());
        assert!(data_entity_fill_area_style_colour("('',#400881);").is_ok());
        assert!(data_entity_fill_area_style_colour("('',#400881);").is_ok());
        assert!(data_entity_fill_area_style_colour("('',#416551);").is_ok());
        assert!(data_entity_fill_area_style_colour("('',#416551);").is_ok());
        assert!(data_entity_fill_area_style_colour("('',#399418);").is_ok());
        assert!(data_entity_fill_area_style_colour("('',#403349);").is_ok());
        assert!(data_entity_fill_area_style_colour("('',#399650);").is_ok());
        assert!(data_entity_fill_area_style_colour("('',#406760);").is_ok());
        assert!(data_entity_fill_area_style_colour("('',#399418);").is_ok());
        assert!(data_entity_fill_area_style_colour("('',#401618);").is_ok());
        assert!(data_entity_fill_area_style_colour("('',#399418);").is_ok());
    }
    ...
    fn test_item_defined_transformation() {
        ...
        assert!(data_entity_item_defined_transformation("('','',#11,#138216);").is_ok());
        assert!(data_entity_item_defined_transformation("('','',#11,#323399);").is_ok());
        assert!(data_entity_item_defined_transformation("('','',#11,#395098);").is_ok());
        assert!(data_entity_item_defined_transformation("('','',#11,#129292);").is_ok());
        assert!(data_entity_item_defined_transformation("('','',#11,#42997);").is_ok());
        assert!(data_entity_item_defined_transformation("('','',#11,#147311);").is_ok());
        assert!(data_entity_item_defined_transformation("('','',#11,#423);").is_ok());
        assert!(data_entity_item_defined_transformation("('','',#11,#47);").is_ok());
        assert!(data_entity_item_defined_transformation("('','',#11,#374606);").is_ok());
        assert!(data_entity_item_defined_transformation("('','',#11,#202273);").is_ok());
        assert!(data_entity_item_defined_transformation("('','',#11,#202161);").is_ok());
        assert!(data_entity_item_defined_transformation("('','',#11,#201181);").is_ok());
        assert!(data_entity_item_defined_transformation("('','',#11,#153128);").is_ok());
        assert!(data_entity_item_defined_transformation("('','',#11,#1151);").is_ok());
        assert!(data_entity_item_defined_transformation("('','',#11,#165863);").is_ok());
    }
    ...
    fn test_line() {
        ...
        assert!(data_entity_line("('',#397906,#397907);").is_ok());
        assert!(data_entity_line("('',#267329,#267330);").is_ok());
        assert!(data_entity_line("('',#140398,#140399);").is_ok());
        assert!(data_entity_line("('',#184450,#184451);").is_ok());
        assert!(data_entity_line("('',#71807,#71808);").is_ok());
        assert!(data_entity_line("('',#272607,#272608);").is_ok());
        assert!(data_entity_line("('',#216534,#216535);").is_ok());
        assert!(data_entity_line("('',#393522,#393523);").is_ok());
        assert!(data_entity_line("('',#353992,#353993);").is_ok());
        assert!(data_entity_line("('',#121426,#121427);").is_ok());
        assert!(data_entity_line("('',#32177,#32178);").is_ok());
        assert!(data_entity_line("('',#205977,#205978);").is_ok());
        assert!(data_entity_line("('',#77176,#77177);").is_ok());
        assert!(data_entity_line("('',#100319,#100320);").is_ok());
        assert!(data_entity_line("('',#57803,#57804);").is_ok());
    }
    ...
    fn test_manifold_solid_brep() {
        ...
        assert!(data_entity_manifold_solid_brep("('',#330032);").is_ok());
        assert!(data_entity_manifold_solid_brep("('',#45829);").is_ok());
        assert!(data_entity_manifold_solid_brep("('',#332933);").is_ok());
        assert!(data_entity_manifold_solid_brep("('',#385683);").is_ok());
        assert!(data_entity_manifold_solid_brep("('',#331756);").is_ok());
        assert!(data_entity_manifold_solid_brep("('',#373560);").is_ok());
        assert!(data_entity_manifold_solid_brep("('',#160740);").is_ok());
        assert!(data_entity_manifold_solid_brep("('',#156900);").is_ok());
        assert!(data_entity_manifold_solid_brep("('',#193028);").is_ok());
        assert!(data_entity_manifold_solid_brep("('',#154027);").is_ok());
        assert!(data_entity_manifold_solid_brep("('',#171915);").is_ok());
        assert!(data_entity_manifold_solid_brep("('',#164808);").is_ok());
        assert!(data_entity_manifold_solid_brep("('',#174415);").is_ok());
        assert!(data_entity_manifold_solid_brep("('',#154879);").is_ok());
        assert!(data_entity_manifold_solid_brep("('',#386536);").is_ok());
    }

    #[test]
    fn test_manifold_surface_shape_representation() {
        assert!(data_entity_manifold_surface_shape_representation("('',(#11,#383554),#383590\n  );").is_ok());
        assert!(data_entity_manifold_surface_shape_representation("('',(#11,#385621),#385657\n  );").is_ok());
        assert!(data_entity_manifold_surface_shape_representation("('',(#11,#131064),#131083\n  );").is_ok());
        assert!(data_entity_manifold_surface_shape_representation("('',(#11,#5821),#5840);").is_ok());
        assert!(data_entity_manifold_surface_shape_representation("('',(#11,#129314),#129333\n  );").is_ok());
        assert!(data_entity_manifold_surface_shape_representation("('',(#11,#389232),#389268\n  );").is_ok());
    }

    #[test]
    fn test_measure_representation_item() {
        assert!(data_entity_measure_representation_item("('volume measure',VOLUME_MEASURE(\n    109.45690237608),#427286);").is_ok());
        assert!(data_entity_measure_representation_item("('surface area measure',\n  AREA_MEASURE(3.584814638318E+003),#427257);").is_ok());
    ...
    fn test_next_assembly_usage_occurrence() {
        assert!(data_entity_next_assembly_usage_occurrence("('3943','869','',#198907,#153103\n  ,$);").is_ok());
        ...
        assert!(data_entity_next_assembly_usage_occurrence("('4036','962','',#145221,#200195\n  ,$);").is_ok());
        assert!(data_entity_next_assembly_usage_occurrence("('3275','201','',#165997,#150290\n  ,$);").is_ok());
        assert!(data_entity_next_assembly_usage_occurrence("('4369','','',#333108,#332216,$\n  );").is_ok());
        assert!(data_entity_next_assembly_usage_occurrence("('2579','','',#24161,#19978,$);").is_ok());
        assert!(data_entity_next_assembly_usage_occurrence("('4518','15','',#387602,#389450,\n  $);").is_ok());
        assert!(data_entity_next_assembly_usage_occurrence("('3890','816','',#145221,#198151\n  ,$);").is_ok());
        assert!(data_entity_next_assembly_usage_occurrence("('4270','','',#5,#323141,$);").is_ok());
        assert!(data_entity_next_assembly_usage_occurrence("('2973','','',#138210,#5554,$);").is_ok());
        assert!(data_entity_next_assembly_usage_occurrence("('4287','','',#323393,#11089,$);").is_ok());
        assert!(data_entity_next_assembly_usage_occurrence("('4573','','',#395092,#381660,$\n  );").is_ok());
        assert!(data_entity_next_assembly_usage_occurrence("('2831','11','',#129254,#129590,\n  $);").is_ok());
        assert!(data_entity_next_assembly_usage_occurrence("('2746','','',#42991,#19978,$);").is_ok());
        assert!(data_entity_next_assembly_usage_occurrence("('4201','1127','',#145221,\n  #202678,$);").is_ok());
        assert!(data_entity_next_assembly_usage_occurrence("('2741','','',#5,#42907,$);").is_ok());
        assert!(data_entity_next_assembly_usage_occurrence("('2550','','',#5,#8942,$);").is_ok());
        assert!(data_entity_next_assembly_usage_occurrence("('4413','','',#374600,#376191,$\n  );").is_ok());
        assert!(data_entity_next_assembly_usage_occurrence("('4183','1109','',#202267,\n  #153103,$);").is_ok());
        assert!(data_entity_next_assembly_usage_occurrence("('4175','1101','',#202155,\n  #153103,$);").is_ok());
        assert!(data_entity_next_assembly_usage_occurrence("('4105','1031','',#201175,\n  #153103,$);").is_ok());
        assert!(data_entity_next_assembly_usage_occurrence("('3084','10','',#153122,#153279,\n  $);").is_ok());
        assert!(data_entity_next_assembly_usage_occurrence("('4308','','',#5,#323673,$);").is_ok());
        assert!(data_entity_next_assembly_usage_occurrence("('3265','191','',#165857,#150290\n  ,$);").is_ok());
    }
    ...
    fn test_oriented_edge() {
        ...
        assert!(data_entity_oriented_edge("('',*,*,#314534,.T.);").is_ok());
        assert!(data_entity_oriented_edge("('',*,*,#296836,.F.);").is_ok());
        assert!(data_entity_oriented_edge("('',*,*,#348565,.F.);").is_ok());
        assert!(data_entity_oriented_edge("('',*,*,#254358,.F.);").is_ok());
        assert!(data_entity_oriented_edge("('',*,*,#359954,.T.);").is_ok());
        assert!(data_entity_oriented_edge("('',*,*,#80840,.F.);").is_ok());
        assert!(data_entity_oriented_edge("('',*,*,#91666,.T.);").is_ok());
        assert!(data_entity_oriented_edge("('',*,*,#308557,.F.);").is_ok());
        assert!(data_entity_oriented_edge("('',*,*,#215618,.T.);").is_ok());
        assert!(data_entity_oriented_edge("('',*,*,#203781,.T.);").is_ok());
        assert!(data_entity_oriented_edge("('',*,*,#195374,.T.);").is_ok());
        assert!(data_entity_oriented_edge("('',*,*,#8281,.T.);").is_ok());
        assert!(data_entity_oriented_edge("('',*,*,#333305,.F.);").is_ok());
        assert!(data_entity_oriented_edge("('',*,*,#360031,.T.);").is_ok());
        assert!(data_entity_oriented_edge("('',*,*,#234296,.F.);").is_ok());
    }

    #[test]
    fn test_over_riding_styled_item() {
        assert!(data_entity_over_riding_styled_item("('overriding color',(#420760),#67182,\n  #416537);").is_ok());
        assert!(data_entity_over_riding_styled_item("('overriding color',(#422093),#74868,\n  #420934);").is_ok());
        assert!(data_entity_over_riding_styled_item("('overriding color',(#403008),#145083,\n  #401621);").is_ok());
        assert!(data_entity_over_riding_styled_item("('overriding color',(#426695),#25323,\n  #426631);").is_ok());
        assert!(data_entity_over_riding_styled_item("('overriding color',(#410405),#375266,\n  #410396);").is_ok());
        assert!(data_entity_over_riding_styled_item("('overriding color',(#412003),#386937,\n  #411897);").is_ok());
        assert!(data_entity_over_riding_styled_item("('overriding color',(#408755),#391252,\n  #408648);").is_ok());
        assert!(data_entity_over_riding_styled_item("('overriding color',(#415312),#38000,\n  #414772);").is_ok());
        assert!(data_entity_over_riding_styled_item("('overriding color',(#422100),#74909,\n  #420934);").is_ok());
        assert!(data_entity_over_riding_styled_item("('overriding color',(#425334),#87487,\n  #420934);").is_ok());
        assert!(data_entity_over_riding_styled_item("('overriding color',(#422296),#75810,\n  #420934);").is_ok());
        assert!(data_entity_over_riding_styled_item("('overriding color',(#418975),#60065,\n  #416537);").is_ok());
        assert!(data_entity_over_riding_styled_item("('overriding color',(#424613),#85024,\n  #420934);").is_ok());
        assert!(data_entity_over_riding_styled_item("('overriding color',(#419668),#62967,\n  #416537);").is_ok());
        assert!(data_entity_over_riding_styled_item("('overriding color',(#422324),#75881,\n  #420934);").is_ok());
        assert!(data_entity_over_riding_styled_item("('overriding color',(#406008),#335418,\n  #405997);").is_ok());
        assert!(data_entity_over_riding_styled_item("('overriding color',(#421652),#73066,\n  #420934);").is_ok());
        assert!(data_entity_over_riding_styled_item("('overriding color',(#424200),#83623,\n  #420934);").is_ok());
        assert!(data_entity_over_riding_styled_item("('overriding color',(#420515),#66295,\n  #416537);").is_ok());
        assert!(data_entity_over_riding_styled_item("('overriding color',(#420970),#67785,\n  #420934);").is_ok());
        assert!(data_entity_over_riding_styled_item("('overriding color',(#415263),#37851,\n  #414772);").is_ok());
        assert!(data_entity_over_riding_styled_item("('overriding color',(#418079),#54363,\n  #416537);").is_ok());
        assert!(data_entity_over_riding_styled_item("('overriding color',(#416560),#46418,\n  #416537);").is_ok());
        assert!(data_entity_over_riding_styled_item("('overriding color',(#414719),#40264,\n  #414676);").is_ok());
        assert!(data_entity_over_riding_styled_item("('overriding color',(#422674),#77695,\n  #420934);").is_ok());
    }
    ...
    fn test_plane() {
        ...
        assert!(data_entity_plane("('',#106368);").is_ok());
        assert!(data_entity_plane("('',#281752);").is_ok());
        assert!(data_entity_plane("('',#102829);").is_ok());
        assert!(data_entity_plane("('',#127989);").is_ok());
        assert!(data_entity_plane("('',#316586);").is_ok());
        assert!(data_entity_plane("('',#364067);").is_ok());
        assert!(data_entity_plane("('',#109044);").is_ok());
        assert!(data_entity_plane("('',#330383);").is_ok());
        assert!(data_entity_plane("('',#220611);").is_ok());
        assert!(data_entity_plane("('',#363771);").is_ok());
        assert!(data_entity_plane("('',#308633);").is_ok());
        assert!(data_entity_plane("('',#254179);").is_ok());
        assert!(data_entity_plane("('',#304266);").is_ok());
        assert!(data_entity_plane("('',#324374);").is_ok());
        assert!(data_entity_plane("('',#259534);").is_ok());
    }
    ...
    fn test_presentation_style_assignment() {
        ...
        assert!(data_entity_presentation_style_assignment("((#405506));").is_ok());
        assert!(data_entity_presentation_style_assignment("((#419277));").is_ok());
        assert!(data_entity_presentation_style_assignment("((#414893));").is_ok());
        assert!(data_entity_presentation_style_assignment("((#411197));").is_ok());
        assert!(data_entity_presentation_style_assignment("((#401528));").is_ok());
        assert!(data_entity_presentation_style_assignment("((#417205));").is_ok());
        assert!(data_entity_presentation_style_assignment("((#405999,#406005));").is_ok());
        assert!(data_entity_presentation_style_assignment("((#424299));").is_ok());
        assert!(data_entity_presentation_style_assignment("((#404489));").is_ok());
        assert!(data_entity_presentation_style_assignment("((#425552));").is_ok());
        assert!(data_entity_presentation_style_assignment("((#410247));").is_ok());
        assert!(data_entity_presentation_style_assignment("((#408546));").is_ok());
        assert!(data_entity_presentation_style_assignment("((#403556));").is_ok());
        assert!(data_entity_presentation_style_assignment("((#401686,#401691));").is_ok());
        assert!(data_entity_presentation_style_assignment("((#418220));").is_ok());
    }
    ...
    fn test_product() {
        ...
        assert!(data_entity_product("('RESC310X160X65L45N','RESC310X160X65L45N','',(#27114));").is_ok());
        assert!(data_entity_product("('C250','C250','',(#194450));").is_ok());
        assert!(data_entity_product("('C220','C220','',(#196502));").is_ok());
        assert!(data_entity_product("('R58','R58','',(#323396));").is_ok());
        assert!(data_entity_product("('C170','C170','',(#197902));").is_ok());
        assert!(data_entity_product("('TP54','TP54','',(#137849));").is_ok());
        assert!(data_entity_product("('TP88','TP88','',(#137177));").is_ok());
        assert!(data_entity_product("('7324893888','7324893888','',(#128794));").is_ok());
        assert!(data_entity_product("('Board','Board','',(#148161));").is_ok());
        assert!(data_entity_product("('C240','C240','',(#194730));").is_ok());
        assert!(data_entity_product("('R48','R48','',(#323676));").is_ok());
        assert!(data_entity_product("('U26','U26','',(#129240));").is_ok());
        assert!(data_entity_product("('R153','R153','',(#165188));").is_ok());
        assert!(data_entity_product("('C9C','C9C','',(#395067));").is_ok());
        assert!(data_entity_product("('TP72','TP72','',(#137569));").is_ok());
        assert!(data_entity_product("('U11','U11','',(#130576));").is_ok());
        assert!(data_entity_product("('C22','C22','',(#394759));").is_ok());
    }
    ...
    fn test_product_definition() {
        ...
        assert!(data_entity_product_definition("('design','',#196500,#196503);").is_ok());
        assert!(data_entity_product_definition("('design','',#323394,#323397);").is_ok());
        assert!(data_entity_product_definition("('design','',#197900,#197903);").is_ok());
        assert!(data_entity_product_definition("('design','',#137847,#137850);").is_ok());
        assert!(data_entity_product_definition("('design','',#137175,#137178);").is_ok());
        assert!(data_entity_product_definition("('design','',#128792,#128795);").is_ok());
        assert!(data_entity_product_definition("('design','',#148159,#148162);").is_ok());
        assert!(data_entity_product_definition("('design','',#194728,#194731);").is_ok());
        assert!(data_entity_product_definition("('design','',#323674,#323677);").is_ok());
        assert!(data_entity_product_definition("('design','',#129238,#129241);").is_ok());
        assert!(data_entity_product_definition("('design','',#165186,#165189);").is_ok());
        assert!(data_entity_product_definition("('design','',#395065,#395068);").is_ok());
        assert!(data_entity_product_definition("('design','',#137567,#137570);").is_ok());
        assert!(data_entity_product_definition("('design','',#130574,#130577);").is_ok());
        assert!(data_entity_product_definition("('design','',#394757,#394760);").is_ok());
    }
    ...
    fn test_product_definition_formation() {
        ...
        assert!(data_entity_product_definition_formation("('','',#196501);").is_ok());
        assert!(data_entity_product_definition_formation("('','',#323395);").is_ok());
        assert!(data_entity_product_definition_formation("('','',#197901);").is_ok());
        assert!(data_entity_product_definition_formation("('','',#137848);").is_ok());
        assert!(data_entity_product_definition_formation("('','',#137176);").is_ok());
        assert!(data_entity_product_definition_formation("('','',#128793);").is_ok());
        assert!(data_entity_product_definition_formation("('','',#148160);").is_ok());
        assert!(data_entity_product_definition_formation("('','',#194729);").is_ok());
        assert!(data_entity_product_definition_formation("('','',#323675);").is_ok());
        assert!(data_entity_product_definition_formation("('','',#129239);").is_ok());
        assert!(data_entity_product_definition_formation("('','',#165187);").is_ok());
        assert!(data_entity_product_definition_formation("('','',#395066);").is_ok());
        assert!(data_entity_product_definition_formation("('','',#137568);").is_ok());
        assert!(data_entity_product_definition_formation("('','',#130575);").is_ok());
        assert!(data_entity_product_definition_formation("('','',#394758);").is_ok());
    }
    ...
    fn test_product_definition_shape() {
        assert!(data_entity_product_definition_shape("('Placement','Placement of an item',\n  #167360);").is_ok());
        assert!(data_entity_product_definition_shape("('Placement','Placement of an item',\n  #359400);").is_ok());
        assert!(data_entity_product_definition_shape("('Placement','Placement of an item',\n  #27513);").is_ok());
        assert!(data_entity_product_definition_shape("('Placement','Placement of an item',\n  #165797);").is_ok());
        ...
        assert!(data_entity_product_definition_shape("('Placement','Placement of an item',\n  #328164);").is_ok());
        assert!(data_entity_product_definition_shape("('Placement','Placement of an item',\n  #167864);").is_ok());
        assert!(data_entity_product_definition_shape("('','',#163015);").is_ok());
        assert!(data_entity_product_definition_shape("('','',#166641);").is_ok());
        assert!(data_entity_product_definition_shape("('Placement','Placement of an item',\n  #200443);").is_ok());
        assert!(data_entity_product_definition_shape("('Placement','Placement of an item',\n  #202403);").is_ok());
        assert!(data_entity_product_definition_shape("('','',#12967);").is_ok());
        assert!(data_entity_product_definition_shape("('','',#383819);").is_ok());
        assert!(data_entity_product_definition_shape("('Placement','Placement of an item',\n  #201955);").is_ok());
        assert!(data_entity_product_definition_shape("('','',#202734);").is_ok());
        assert!(data_entity_product_definition_shape("('','',#200923);").is_ok());
        assert!(data_entity_product_definition_shape("('Placement','Placement of an item',\n  #167785);").is_ok());
        assert!(data_entity_product_definition_shape("('','',#323281);").is_ok());
    }
    ...
    fn test_product_related_product_category() {
        ...
        assert!(data_entity_product_related_product_category("('part',$,(#196557));").is_ok());
        assert!(data_entity_product_related_product_category("('part',$,(#323395));").is_ok());
        assert!(data_entity_product_related_product_category("('part',$,(#197957));").is_ok());
        assert!(data_entity_product_related_product_category("('part',$,(#137848));").is_ok());
        assert!(data_entity_product_related_product_category("('part',$,(#137176));").is_ok());
        assert!(data_entity_product_related_product_category("('part',$,(#128793));").is_ok());
        assert!(data_entity_product_related_product_category("('part',$,(#148173));").is_ok());
        assert!(data_entity_product_related_product_category("('part',$,(#194785));").is_ok());
        assert!(data_entity_product_related_product_category("('part',$,(#323675));").is_ok());
        assert!(data_entity_product_related_product_category("('part',$,(#129342));").is_ok());
        assert!(data_entity_product_related_product_category("('part',$,(#165243));").is_ok());
        assert!(data_entity_product_related_product_category("('part',$,(#395066));").is_ok());
        assert!(data_entity_product_related_product_category("('part',$,(#137568));").is_ok());
        assert!(data_entity_product_related_product_category("('part',$,(#130765));").is_ok());
        assert!(data_entity_product_related_product_category("('part',$,(#394758));").is_ok());
    }

    #[test]
    fn test_property_definition() {
        assert!(data_entity_property_definition("('geometric_validation_property','centroid'\n  ,#427273);").is_ok());
        assert!(data_entity_property_definition("('material property','material name',\n  #321263);").is_ok());
        assert!(data_entity_property_definition("('shape with specific properties',\n  'properties for subshape',#427251);").is_ok());
        assert!(data_entity_property_definition("('geometric_validation_property','volume',\n  #427251);").is_ok());
        assert!(data_entity_property_definition("('geometric_validation_property','centroid'\n  ,#427251);").is_ok());
        assert!(data_entity_property_definition("('geometric_validation_property',\n  'surface area',#427273);").is_ok());
        assert!(data_entity_property_definition("('material property','material name',\n  #356697);").is_ok());
        assert!(data_entity_property_definition("('geometric_validation_property',\n  'surface area',#427251);").is_ok());
        assert!(data_entity_property_definition("('shape with specific properties',\n  'properties for subshape',#427273);").is_ok());
        assert!(data_entity_property_definition("('material property','density',#321263);").is_ok());
        assert!(data_entity_property_definition("('material property','density',#356697);").is_ok());
        assert!(data_entity_property_definition("('geometric_validation_property','volume',\n  #427273);").is_ok());
    }
    ...
    fn test_representation() {
        ...
        assert!(data_entity_representation("($  /*   NUL REF   */,(),$\n    /*   NUL REF   */);").is_ok());
        assert!(data_entity_representation("($  /*   NUL REF   */,(),$\n    /*   NUL REF   */);").is_ok());
    }
    ...
    fn test_shape_definition_representation() {
        ...
        assert!(data_entity_shape_definition_representation("(#378862,#378868);").is_ok());
        assert!(data_entity_shape_definition_representation("(#197142,#197148);").is_ok());
        assert!(data_entity_shape_definition_representation("(#380410,#380416);").is_ok());
        assert!(data_entity_shape_definition_representation("(#199046,#199052);").is_ok());
        assert!(data_entity_shape_definition_representation("(#191806,#191812);").is_ok());
        assert!(data_entity_shape_definition_representation("(#194698,#194704);").is_ok());
        assert!(data_entity_shape_definition_representation("(#188047,#187890);").is_ok());
        assert!(data_entity_shape_definition_representation("(#196554,#196560);").is_ok());
        assert!(data_entity_shape_definition_representation("(#42934,#42940);").is_ok());
        assert!(data_entity_shape_definition_representation("(#162327,#162170);").is_ok());
        assert!(data_entity_shape_definition_representation("(#137173,#137179);").is_ok());
        assert!(data_entity_shape_definition_representation("(#166920,#166926);").is_ok());
        assert!(data_entity_shape_definition_representation("(#184061,#183512);").is_ok());
        assert!(data_entity_shape_definition_representation("(#192674,#192680);").is_ok());
        assert!(data_entity_shape_definition_representation("(#197478,#197484);").is_ok());
    }
    ...
    fn test_shape_representation() {
        ...
        assert!(data_entity_shape_representation("('',(#11,#11152,#11574,#11996,#12418),\n  #12960);").is_ok());
        ...
        assert!(data_entity_shape_representation("('',(#11,#201629),#201633);").is_ok());
        assert!(data_entity_shape_representation("('',(#11,#202796),#202800);").is_ok());
        assert!(data_entity_shape_representation("('',(#11,#165443),#165447);").is_ok());
        assert!(data_entity_shape_representation("('',(#11,#27780),#27784);").is_ok());
        assert!(data_entity_shape_representation("('',(#11,#200845),#200849);").is_ok());
        assert!(data_entity_shape_representation("('',(#11,#161703),#161707);").is_ok());
        assert!(data_entity_shape_representation("('',(#11,#364888),#364892);").is_ok());
        assert!(data_entity_shape_representation("('',(#11,#192401),#192405);").is_ok());
        assert!(data_entity_shape_representation("('',(#11,#380389),#380393);").is_ok());
        assert!(data_entity_shape_representation("('',(#11,#197541),#197545);").is_ok());
        assert!(data_entity_shape_representation("('',(#11,#137264),#137268);").is_ok());
        assert!(data_entity_shape_representation("('',(#11,#139280),#139284);").is_ok());
        assert!(data_entity_shape_representation("('',(#11,#41795),#41799);").is_ok());
        assert!(data_entity_shape_representation("('',(#11,#328319),#328323);").is_ok());
        assert!(data_entity_shape_representation("('',(#11,#136956),#136960);").is_ok());
    }
    ...
    fn test_spherical_surface() {
        ...
        assert!(data_entity_spherical_surface("('',#380679,5.E-002);").is_ok());
        assert!(data_entity_spherical_surface("('',#175003,5.E-002);").is_ok());
        assert!(data_entity_spherical_surface("('',#152045,5.E-002);").is_ok());
        assert!(data_entity_spherical_surface("('',#379940,5.E-002);").is_ok());
        assert!(data_entity_spherical_surface("('',#171363,5.E-002);").is_ok());
        assert!(data_entity_spherical_surface("('',#190121,5.E-002);").is_ok());
        assert!(data_entity_spherical_surface("('',#176955,5.E-002);").is_ok());
        assert!(data_entity_spherical_surface("('',#188622,5.E-002);").is_ok());
        assert!(data_entity_spherical_surface("('',#178239,5.E-002);").is_ok());
        assert!(data_entity_spherical_surface("('',#180123,5.E-002);").is_ok());
        assert!(data_entity_spherical_surface("('',#45754,0.1);").is_ok());
        assert!(data_entity_spherical_surface("('',#324591,1.38E-002);").is_ok());
        assert!(data_entity_spherical_surface("('',#193335,5.E-002);").is_ok());
        assert!(data_entity_spherical_surface("('',#379194,5.E-002);").is_ok());
        assert!(data_entity_spherical_surface("('',#195366,5.E-002);").is_ok());
    }
    ...
    fn test_styled_item() {
        ...
        assert!(data_entity_styled_item("('color',(#413592),#373105);").is_ok());
        assert!(data_entity_styled_item("('color',(#406562),#153220);").is_ok());
        assert!(data_entity_styled_item("('color',(#412149),#24306);").is_ok());
        assert!(data_entity_styled_item("('color',(#412918),#162816);").is_ok());
        assert!(data_entity_styled_item("('color',(#407064),#389293);").is_ok());
        assert!(data_entity_styled_item("('color',(#414411),#39136);").is_ok());
        assert!(data_entity_styled_item("('color',(#409166),#170965);").is_ok());
        assert!(data_entity_styled_item("('color',(#403493),#376272);").is_ok());
        assert!(data_entity_styled_item("('color',(#414240),#19681);").is_ok());
        assert!(data_entity_styled_item("('color',(#411666),#127951);").is_ok());
        assert!(data_entity_styled_item("('color',(#416528),#164106);").is_ok());
        assert!(data_entity_styled_item("('color',(#415894),#372689);").is_ok());
        assert!(data_entity_styled_item("('color',(#407084),#399012);").is_ok());
        assert!(data_entity_styled_item("('color',(#425997),#5431);").is_ok());
        assert!(data_entity_styled_item("('color',(#405154),#149883);").is_ok());
    }
    ...
    fn test_surface_side_style() {
        ...
        assert!(data_entity_surface_side_style("('',(#422173));").is_ok());
        assert!(data_entity_surface_side_style("('',(#422964));").is_ok());
        assert!(data_entity_surface_side_style("('',(#408450));").is_ok());
        assert!(data_entity_surface_side_style("('',(#424532));").is_ok());
        assert!(data_entity_surface_side_style("('',(#401530));").is_ok());
        assert!(data_entity_surface_side_style("('',(#407967));").is_ok());
        assert!(data_entity_surface_side_style("('',(#419552));").is_ok());
        assert!(data_entity_surface_side_style("('',(#424308));").is_ok());
        assert!(data_entity_surface_side_style("('',(#404491));").is_ok());
        assert!(data_entity_surface_side_style("('',(#414292));").is_ok());
        assert!(data_entity_surface_side_style("('',(#410429));").is_ok());
        assert!(data_entity_surface_side_style("('',(#407322));").is_ok());
        assert!(data_entity_surface_side_style("('',(#403558));").is_ok());
        assert!(data_entity_surface_side_style("('',(#401688));").is_ok());
        assert!(data_entity_surface_side_style("('',(#412343));").is_ok());
    }
    ...
    fn test_surface_style_fill_area() {
        ...
        assert!(data_entity_surface_style_fill_area("(#422174);").is_ok());
        assert!(data_entity_surface_style_fill_area("(#422965);").is_ok());
        assert!(data_entity_surface_style_fill_area("(#408451);").is_ok());
        assert!(data_entity_surface_style_fill_area("(#424533);").is_ok());
        assert!(data_entity_surface_style_fill_area("(#401531);").is_ok());
        assert!(data_entity_surface_style_fill_area("(#407968);").is_ok());
        assert!(data_entity_surface_style_fill_area("(#419553);").is_ok());
        assert!(data_entity_surface_style_fill_area("(#424309);").is_ok());
        assert!(data_entity_surface_style_fill_area("(#404492);").is_ok());
        assert!(data_entity_surface_style_fill_area("(#414293);").is_ok());
        assert!(data_entity_surface_style_fill_area("(#410430);").is_ok());
        assert!(data_entity_surface_style_fill_area("(#407323);").is_ok());
        assert!(data_entity_surface_style_fill_area("(#403559);").is_ok());
        assert!(data_entity_surface_style_fill_area("(#401689);").is_ok());
        assert!(data_entity_surface_style_fill_area("(#412344);").is_ok());
    }
    ...
    fn test_surface_style_usage() {
        ...
        assert!(data_entity_surface_style_usage("(.BOTH.,#422172);").is_ok());
        assert!(data_entity_surface_style_usage("(.BOTH.,#422963);").is_ok());
        assert!(data_entity_surface_style_usage("(.BOTH.,#408449);").is_ok());
        assert!(data_entity_surface_style_usage("(.BOTH.,#424531);").is_ok());
        assert!(data_entity_surface_style_usage("(.BOTH.,#401529);").is_ok());
        assert!(data_entity_surface_style_usage("(.BOTH.,#407966);").is_ok());
        assert!(data_entity_surface_style_usage("(.BOTH.,#419551);").is_ok());
        assert!(data_entity_surface_style_usage("(.BOTH.,#424307);").is_ok());
        assert!(data_entity_surface_style_usage("(.BOTH.,#404490);").is_ok());
        assert!(data_entity_surface_style_usage("(.BOTH.,#414291);").is_ok());
        assert!(data_entity_surface_style_usage("(.BOTH.,#410428);").is_ok());
        assert!(data_entity_surface_style_usage("(.BOTH.,#407321);").is_ok());
        assert!(data_entity_surface_style_usage("(.BOTH.,#403557);").is_ok());
        assert!(data_entity_surface_style_usage("(.BOTH.,#401687);").is_ok());
        assert!(data_entity_surface_style_usage("(.BOTH.,#412342);").is_ok());
    }
    ...
    fn test_toroidal_surface() {
        ...
        assert!(data_entity_toroidal_surface("('',#227522,1.4,0.4);").is_ok());
        assert!(data_entity_toroidal_surface("('',#335347,4.9,0.1);").is_ok());
        assert!(data_entity_toroidal_surface("('',#42667,3.15,0.5);").is_ok());
        assert!(data_entity_toroidal_surface("('',#42487,2.9,0.25);").is_ok());
        assert!(data_entity_toroidal_surface("('',#42725,2.9,0.25);").is_ok());
        assert!(data_entity_toroidal_surface("('',#394488,0.113,1.2E-002);").is_ok());
        assert!(data_entity_toroidal_surface("('',#42531,2.9,0.25);").is_ok());
        assert!(data_entity_toroidal_surface("('',#335131,4.9,0.1);").is_ok());
        assert!(data_entity_toroidal_surface("('',#227285,1.4,0.4);").is_ok());
        assert!(data_entity_toroidal_surface("('',#335095,1.15,0.1);").is_ok());
        assert!(data_entity_toroidal_surface("('',#333427,4.9,0.1);").is_ok());
        assert!(data_entity_toroidal_surface("('',#335885,1.7,0.2);").is_ok());
        assert!(data_entity_toroidal_surface("('',#393127,0.113,1.2E-002);").is_ok());
        assert!(data_entity_toroidal_surface("('',#335239,1.15,0.1);").is_ok());
        assert!(data_entity_toroidal_surface("('',#42713,2.9,0.25);").is_ok());
    }
    ...
    fn test_uncertainty_measure_with_unit() {
        assert!(data_entity_uncertainty_measure_with_unit("(LENGTH_MEASURE(1.E-007),#200822,\n  'distance_accuracy_value','confusion accuracy');").is_ok());
        assert!(data_entity_uncertainty_measure_with_unit("(LENGTH_MEASURE(1.E-007),#395339,\n  'distance_accuracy_value','confusion accuracy');").is_ok());
        assert!(data_entity_uncertainty_measure_with_unit("(LENGTH_MEASURE(5.E-006),#153748,\n  'distance_accuracy_value','confusion accuracy');").is_ok());
        assert!(data_entity_uncertainty_measure_with_unit("(LENGTH_MEASURE(1.E-007),#136989,\n  'distance_accuracy_value','confusion accuracy');").is_ok());
        assert!(data_entity_uncertainty_measure_with_unit("(LENGTH_MEASURE(5.E-006),#322956,\n  'distance_accuracy_value','confusion accuracy');").is_ok());
        assert!(data_entity_uncertainty_measure_with_unit("(LENGTH_MEASURE(1.E-007),#197742,\n  'distance_accuracy_value','confusion accuracy');").is_ok());
        assert!(data_entity_uncertainty_measure_with_unit("(LENGTH_MEASURE(1.E-007),#387568,\n  'distance_accuracy_value','confusion accuracy');").is_ok());
        assert!(data_entity_uncertainty_measure_with_unit("(LENGTH_MEASURE(1.E-007),#128991,\n  'distance_accuracy_value','confusion accuracy');").is_ok());
        assert!(data_entity_uncertainty_measure_with_unit("(LENGTH_MEASURE(2.E-006),#27105,\n  'distance_accuracy_value','confusion accuracy');").is_ok());
        assert!(data_entity_uncertainty_measure_with_unit("(LENGTH_MEASURE(1.E-007),#194458,\n  'distance_accuracy_value','confusion accuracy');").is_ok());
        assert!(data_entity_uncertainty_measure_with_unit("(LENGTH_MEASURE(1.E-007),#196510,\n  'distance_accuracy_value','confusion accuracy');").is_ok());
        assert!(data_entity_uncertainty_measure_with_unit("(LENGTH_MEASURE(5.E-006),#323404,\n  'distance_accuracy_value','confusion accuracy');").is_ok());
        assert!(data_entity_uncertainty_measure_with_unit("(LENGTH_MEASURE(1.E-007),#197910,\n  'distance_accuracy_value','confusion accuracy');").is_ok());
        assert!(data_entity_uncertainty_measure_with_unit("(LENGTH_MEASURE(1.E-007),#137857,\n  'distance_accuracy_value','confusion accuracy');").is_ok());
        assert!(data_entity_uncertainty_measure_with_unit("(LENGTH_MEASURE(1.E-007),#137185,\n  'distance_accuracy_value','confusion accuracy');").is_ok());
        assert!(data_entity_uncertainty_measure_with_unit("(LENGTH_MEASURE(1.E-007),#128802,\n  'distance_accuracy_value','confusion accuracy');").is_ok());
        assert!(data_entity_uncertainty_measure_with_unit("(LENGTH_MEASURE(1.E-007),#148152,\n  'distance_accuracy_value','confusion accuracy');").is_ok());
        assert!(data_entity_uncertainty_measure_with_unit("(LENGTH_MEASURE(1.E-007),#194738,\n  'distance_accuracy_value','confusion accuracy');").is_ok());
        assert!(data_entity_uncertainty_measure_with_unit("(LENGTH_MEASURE(5.E-006),#323684,\n  'distance_accuracy_value','confusion accuracy');").is_ok());
        assert!(data_entity_uncertainty_measure_with_unit("(LENGTH_MEASURE(1.E-007),#129248,\n  'distance_accuracy_value','confusion accuracy');").is_ok());
        assert!(data_entity_uncertainty_measure_with_unit("(LENGTH_MEASURE(5.E-006),#165196,\n  'distance_accuracy_value','confusion accuracy');").is_ok());
        assert!(data_entity_uncertainty_measure_with_unit("(LENGTH_MEASURE(1.E-007),#395075,\n  'distance_accuracy_value','confusion accuracy');").is_ok());
        assert!(data_entity_uncertainty_measure_with_unit("(LENGTH_MEASURE(1.E-007),#137577,\n  'distance_accuracy_value','confusion accuracy');").is_ok());
        assert!(data_entity_uncertainty_measure_with_unit("(LENGTH_MEASURE(1.E-007),#130584,\n  'distance_accuracy_value','confusion accuracy');").is_ok());
        assert!(data_entity_uncertainty_measure_with_unit("(LENGTH_MEASURE(1.E-007),#394767,\n  'distance_accuracy_value','confusion accuracy');").is_ok());
    }
    ...
    fn test_vector() {
        ...
        assert!(data_entity_vector("('',#65108,1.);").is_ok());
        assert!(data_entity_vector("('',#341329,1.);").is_ok());
        assert!(data_entity_vector("('',#365317,1.);").is_ok());
        assert!(data_entity_vector("('',#184489,1.);").is_ok());
        assert!(data_entity_vector("('',#149049,1.);").is_ok());
        assert!(data_entity_vector("('',#132158,1.);").is_ok());
        assert!(data_entity_vector("('',#258166,1.);").is_ok());
        assert!(data_entity_vector("('',#247477,1.);").is_ok());
        assert!(data_entity_vector("('',#353994,1.);").is_ok());
        assert!(data_entity_vector("('',#377779,1.);").is_ok());
        assert!(data_entity_vector("('',#344019,1.);").is_ok());
        assert!(data_entity_vector("('',#324977,1.);").is_ok());
        assert!(data_entity_vector("('',#204537,1.);").is_ok());
        assert!(data_entity_vector("('',#284546,1.);").is_ok());
        assert!(data_entity_vector("('',#295335,1.);").is_ok());
    }
    ...
    fn test_vertex_point() {
        ...
        assert!(data_entity_vertex_point("('',#155673);").is_ok());
        assert!(data_entity_vertex_point("('',#94234);").is_ok());
        assert!(data_entity_vertex_point("('',#8267);").is_ok());
        assert!(data_entity_vertex_point("('',#69818);").is_ok());
        assert!(data_entity_vertex_point("('',#349679);").is_ok());
        assert!(data_entity_vertex_point("('',#209757);").is_ok());
        assert!(data_entity_vertex_point("('',#223660);").is_ok());
        assert!(data_entity_vertex_point("('',#261584);").is_ok());
        assert!(data_entity_vertex_point("('',#38256);").is_ok());
        assert!(data_entity_vertex_point("('',#105056);").is_ok());
        assert!(data_entity_vertex_point("('',#209655);").is_ok());
        assert!(data_entity_vertex_point("('',#190043);").is_ok());
        assert!(data_entity_vertex_point("('',#358001);").is_ok());
        assert!(data_entity_vertex_point("('',#46718);").is_ok());
        assert!(data_entity_vertex_point("('',#180042);").is_ok());
    }
